...
class DataUtil {
    ...
    static sort(ds, field, comparer) {
        ...
        const middle = parseInt((ds.length / 2).toString(), 10);
...
class ODataAdaptor extends UrlAdaptor {
    ...
    batchRequest(dm, changes, e, query, original) {
        ...
        const url = this.rootUrl ? this.rootUrl + '/' + this.options.batch :
    ...
    */
    ...
    makeRequest(url, deffered, args, query) {
        ...
        const fnSuccess = (data, request) => {
            ...
            let result = this.adaptor.processResponse(data, this, query, request.fetchRequest, request);
            let count = 0;
            let aggregates = null;
